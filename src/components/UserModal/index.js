...
import { Form, Input, Select, Row, Col, Image, Modal, Card } from 'antd';
import { EyeOutlined } from '@ant-design/icons';
const UserModal = ({ form, docImage }) => {
      ...
      >
        <Row gutter={16}>
          ...
          <Col xs={24} sm={24} md={6} lg={6} xl={6}>
            <div>
              <span className="formLabel mr-1">Electronic Signature</span>
              <EyeOutlined
                onClick={() => {
                  setSignatureImage(docImage?.electronicSignatureDoc);
                }}
              />
            </div>
            <img src={docImage?.electronicSignatureDoc} width={150} height={140} />
          </Col>
          ...
          <Col xs={24} sm={24} md={6} lg={6} xl={6}>
            ...
            <iframe src={docImage?.insuranceDoc?.url} width={150} />
          </Col>
          <Col xs={24} sm={24} md={6} lg={6} xl={6}>
            <div className="flex">
            ...
            <iframe src={docImage?.licDoc?.url} width={150} />
          </Col>
          <Col xs={24} sm={24} md={6} lg={6} xl={6}>
            <div className="flex">
            ...
            <iframe src={docImage?.utilityBillAndResidenceBillDoc?.url} width={150} />
          </Col>
        </Row>
        <Modal
